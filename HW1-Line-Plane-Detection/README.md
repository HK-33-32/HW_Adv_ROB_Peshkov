...
**Home Assignment #1** (Advanced Robotics, Spring 2026, Dr. Ilya Afanasyev)
...
* Hough Transform уверенно находит все 4 стены даже при наличии шума.  
* RANSAC успешно выделяет плоскость пола (~24% инлайеров на тестовом датасете).  
* Оба алгоритма реализованы чисто, визуализированы и сохранены в `images/`.  
* Код готов к использованию на реальных сканах Velodyne / Kinect.