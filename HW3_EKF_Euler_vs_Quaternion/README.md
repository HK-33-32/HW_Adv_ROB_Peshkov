...
Полный код, все расчёты и воспроизводимые графики — в `HW3_EKF_Euler_vs_Quaternion.ipynb`.

## Conclusions

Quaternion-based EKF явно превосходит Euler-based по стабильности и устойчивости к Gimbal Lock. График нормы подтверждает необходимость принудительной нормализации. Реализация соответствует стандартам чистого и воспроизводимого кода (Reproducible Research).